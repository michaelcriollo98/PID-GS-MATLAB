...
t = 0:1:length(ref1)-1;
SettlingMin = 5.15 /25*100;
SettlingMax = 4.85 /25*100 ;
...
filename1 = "Altura_AS-PID_FallaT1_p3";
signal1 = load(filename1);
H1S = signal1.graf1(1).y;
H1S = medfilt1(H1S,5)/25*100 ;
ref1S = signal1.graf1(3).y/25*100 ;
...
% 
% 
ref1F = [ref1(init1:fin1) ref1(init2:fin2) ref1S(init3:fin3)];
ref2F = [ref2(init4:fin4) ref2(init5:fin5) ref2(init6:fin6)];
H1F = [H1(init1:fin1) H1(init2:fin2) H1S(init3:fin3)];
